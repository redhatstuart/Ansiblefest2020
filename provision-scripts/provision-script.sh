...
echo "*************************************************************G*******************************"
        ...
        runuser -l student -c "pip-2.7 install --user ansible==2.10.0"
...
echo "********************************************************************************************"
	echo "`date` -- Installing noVNC environment" >>/root/provision-script-output.log
        ...
        wget --quiet -P /etc/systemd/system https://raw.githubusercontent.com/stuartatmicrosoft/Ansiblefest2020/main/provision-scripts/websockify.service
	wget --quiet --no-check-certificate -P /etc/systemd/system "https://raw.githubusercontent.com/stuartatmicrosoft/Ansiblefest2020/main/provision-scripts/vncserver@:4.service"
	...
	wget --quiet --no-check-certificate -P /home/student/.vnc https://raw.githubusercontent.com/stuartatmicrosoft/Ansiblefest2020/main/provision-scripts/passwd
	wget --quiet --no-check-certificate -P /home/student/.vnc https://raw.githubusercontent.com/stuartatmicrosoft/Ansiblefest2020/main/provision-scripts/xstartup
...
echo "********************************************************************************************"
	...
	wget --quiet -P /home/student/.local/share/keyrings https://raw.githubusercontent.com/stuartatmicrosoft/Ansiblefest2020/main/provision-scripts/Default.keyring
...
echo "********************************************************************************************"
        ...
        cd /usr/local/bin
        wget -P /usr/local/bin https://raw.githubusercontent.com/stuartatmicrosoft/Ansiblefest2020/main/provision-scripts/oc.tar.gz
        tar xvfz oc.tar.gz
        rm -f oc.tar.gz
echo "********************************************************************************************"
